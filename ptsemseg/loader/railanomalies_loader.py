...
class railanomaliesLoader(data.Dataset):
    ...
    def __init__(
        ...
        """
        if root is None:
            root = os.path.expandvars('$RAILANOMALIES_DATASET')
        self.root = root
        self.split = split
        ...
        self.images_base = os.path.join(self.root, self.split + "_images")
        self.annotations_base = os.path.join(self.root, self.split+ "_masks")
