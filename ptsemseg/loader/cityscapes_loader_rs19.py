...
class cityscapesLoader_rs19(data.Dataset):
    """cityscapesLoader
    ...
    def __init__(
        ...
        self.annotations_base = os.path.join(self.root, "annotations_all")
    ...
    def decode_segmap(self, temp):
        ...
        rgb = np.zeros((temp.shape[0], temp.shape[1]))
        rgb[:, :] = r / 255.0
        # rgb[:, :, 1] = g / 255.0
        # rgb[:, :, 2] = b / 255.0
...
if __name__ == "__main__":
    ...
    local_path = "/home/stanik/rtis_lab/data/Cityscapes/"
    dst = cityscapesLoader_rs19(local_path, is_transform=True, augmentations=augmentations)
    bs = 4
